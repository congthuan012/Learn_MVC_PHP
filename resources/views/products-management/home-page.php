                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="inner-content">
                              <div class="product-thumb">
                                <a href="single-product-simple.html">
                                  <img class="w-100" src="<?= asset('assets/img/shop/1.jpg') ?>" alt="Image-HasTech">
                                </a>
                          ...
                          <div class="product-item">
                            <div class="inner-content">
                              <div class="product-thumb">
                                <a href="single-product-simple.html">
                                  <img class="w-100" src="<?= asset('assets/img/shop/2.jpg') ?>" alt="Image-HasTech">
                                </a>
                                <span class="sale-title sticker">Sale</span>
                  ...
                  <div class="col-sm-6 col-lg-4 col-xl-3">
                    ...
                    <div class="product-item">
                      <div class="inner-content">
                        <div class="product-thumb">
                          <a href="single-product-simple.html">
                            <img class="w-100" src="<?= asset('assets/img/shop/5.jpg') ?>" alt="Image-HasTech">
                          </a>
                          <div class="product-action">
                            <div class="addto-wrap">
                              <a class="add-cart" href="cart.html">
                  ...
                  <div class="col-sm-6 col-lg-4 col-xl-3 d-none d-lg-block">
                    ...
                    <div class="product-item">
                      <div class="inner-content">
                        <div class="product-thumb">
                          <a href="single-product-simple.html">
                            <img class="w-100" src="<?= asset('assets/img/shop/3.jpg') ?>" alt="Image-HasTech">
                          </a>
                          <span class="sale-title sticker">Sale</span>
      ...
      <div class="row">
        <div class="col-sm-6">
          ...
          <div class="single-banner-image">
            <a href="shop.html">
              <img class="w-100" src="<?= asset('assets/img/shop/banner/3.jpg') ?>" alt="Image-HasTech">
            </a>
          </div>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  ...
                  <div class="brand-logo-item">
                    <a href="shop.html"><img src="<?= asset('assets/img/brand-logo/1.jpg') ?>" alt="Image-HasTech"></a>
                  </div>
                  <!--== End Brand Logo Item ==-->
                </div>
              </div>
                  ...
                  <div class="inner-content">
                    <div class="thumb">
                      <a href="single-blog.html">
                        <img class="w-100" src="<?= asset('assets/img/blog/1.jpg') ?>" alt="Image-HasTech">
                      </a>
                    </div>
                    <div class="content">
                      <ul class="meta">
